...
export const metrics: Metric[] = [
  ...
  },
  {
    ...
    nameNo: "Årlig tilvekst",
    unit: "mill. m³/år",
    definitionNo:
      "Brutto årlig volumtilvekst på levende trær før avvirkning og naturlig avgang.",
    uncertaintyNo:
      "Modellert fra takstdata; enkeltår kan variere med klima og takstmetodikk.",
    direction: "up-good",
    sourceId: "ssb",
  },
  {
    id: "harvest",
    name: "Harvest / fellings",
    nameNo: "Avvirkning",
    unit: "mill. m³/år",
    definitionNo:
      "Total avvirkning av industrivirke og ved (bruttovolum, alle sortiment).",
    uncertaintyNo:
      "Salgsvirke rapporteres presist; ved til eget bruk er anslått.",
    direction: "neutral",
    sourceId: "ssb",
  },
  {
    id: "carbon_stock",
    name: "Carbon stock in living biomass",
  ...
  {
    id: "biomass_per_ha",
    name: "Above-ground biomass per hectare",
    nameNo: "Biomasse per hektar",
    unit: "tonn/ha",
    definitionNo:
      "Overjordisk levende biomasse per hektar skog (FAO-definisjon).",
    uncertaintyNo:
      "FRA rapporterer for utvalgte år; verdier mellom år er interpolert.",
    direction: "up-good",
    sourceId: "fao-fra",
  },
  {
  ...
  },
  {
    ...
    unit: "ppm",
    definitionNo:
      "Global gjennomsnittlig atmosfærisk CO₂-konsentrasjon (tørr molfraksjon).",
    uncertaintyNo:
      "Svært presise målinger; global middelverdi utjevner sesongvariasjon.",
    direction: "down-good",
    sourceId: "gcp",
  },
];
